...
function blueprint(){
  ...
  window.setTimeout(() => transition.classList.add('active'), 480);
  window.setTimeout(() => { app.classList.add('blueprint-on'); window.scrollTo({top:0, behavior:'instant'}); }, 760);
  window.setTimeout(() => { transition.classList.remove('active'); app.classList.remove('uav-inspecting'); }, 1420);
}
